...
import 'package:safeline/app_constants.dart' as constants;
import 'package:safeline/services/size_config.dart';
import 'package:safeline/widgets/app_drawer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(color: constants.onPrimary),
